...
Nonsense_splt <- unlist(str_split(nonsense, pattern = "\n" ))
Nonsense <- str_c(str_trim(Nonsense_splt), collapse = " ")
# Exercise 3 ----------------------------------------------------------------------------------------------------------

# Count the number of times that the word "me" appears in Frankenstein. Resist the urge to do this manually!

me <- str_count(Frankenstein, pattern = " \\bme\\b ")
# Exercise 4 ----------------------------------------------------------------------------------------------------------
...
Nonsense <- str_replace(Nonsense, pattern = "\\bBee\\b", replacement = "Donkey")
# Exercise 6 ----------------------------------------------------------------------------------------------------------

# Wrap the Frankenstein text into a paragraph with at most 80 characters per line.
Frankenstein <- cat(str_wrap(Frankenstein))